...
--update prescription
UPDATE prescription SET prescription = prescription || CHR(10) || CHR(10) ||'SLEEP '  WHERE id = 1;

--
SELECT prescription FROM prescription WHERE id = 1;
...
--updates by appending CHR(10) new line

UPDATE patient SET anamnesis = anamnesis || CHR(10) || CHR(10) ||'GOOOD VERY GOOD ' 
, diagnosis = diagnosis || CHR(10) || CHR(10) ||'BOLNOIIII '  WHERE id = 1;

--
SELECT anamnesis FROM patient WHERE id = 1;

--
SELECT anamnesis FROM patient WHERE id = 2;

SELECT  diagnosis FROM patient WHERE id = 2;
...
INSERT INTO laboratory (labname, labaddress, labphone) 
VALUES ('Clinique Médicale Plexo ', '6100 Avenue du Boisé, Montreal, QC H3S 2W1', '514-251-9331');
INSERT INTO laboratory (labname, labaddress, labphone) 
