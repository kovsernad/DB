...
public class ActivePatient implements KeyListener, ListSelectionListener, ActionListener
{
    ...
    private void init() {
        ...
        this.function.fillPatient(actPatient);
...
//                GridBagConstraints.BOTH, new Insets(15, 15, 15, 15), 0, 0));
        ...
        //filling hospitals list
        function.setHospitalsList(listModel3);
    ...
    public void actionPerformed(ActionEvent e){
     ...
     public void valueChanged(ListSelectionEvent e) {
            ...
            if (this.MAPanel.getSelectedIndex() == 0  &&
                ...
                patientid = function.patientInfoByItem(actPatient, st, patientTF, tpPresciption, null);
                this.function.fillTests(tests, patientid);
                this.function.testListMA(tests, listModel2);
