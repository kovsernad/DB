...
public class Patients implements ActionListener {
    ...
    public void patient(String[] lab, JPanel patientPane, int loggedId) {
        ...
        JButton print = new JButton("Next Page");
        ...
        this.patientPane.add(print, new GridBagConstraints(4, 6, 1, 1, 0, 0, GridBagConstraints.LAST_LINE_END,
...
//    try {
        ...
        this.function.getPrintPatientInfo(patient, this.tpPrescriptions, tmp);
        System.out.println(tmp.getText());
//        tmp.print(null, null, show, null, null, show);
